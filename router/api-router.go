...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		securityAuditRoute.Use(middleware.DisableCache(), middleware.RootAuth())
		{
			...
			securityAuditRoute.PUT("/builtin-policy", middleware.CriticalRateLimit(), controller.UpdateSecurityAuditBuiltinPolicy)
			...
			securityAuditRoute.PUT("/request-archive/config", middleware.CriticalRateLimit(), controller.UpdateRequestArchiveConfig)
