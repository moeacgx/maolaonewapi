...
local includeQuota = ARGV[10] == '1'
local quotaIncoming = tonumber(ARGV[12])
...
if includeQuota and (redis.call('HEXISTS', KEYS[1], 'Quota') == 0 or quotaCurrent <= 0 or cacheSchema ~= tonumber(ARGV[9])) then
