...
type ChannelOtherSettings struct {
	...
	ClaudeCodeFingerprintEnabled          bool                  `json:"claude_code_fingerprint_enabled,omitempty"`
	ClaudeCodeTransportFingerprintEnabled bool                  `json:"claude_code_transport_fingerprint_enabled,omitempty"`
	ClaudeCodeVersion                     string                `json:"claude_code_version,omitempty"`
	ClaudeCodeEntrypoint                  string                `json:"claude_code_entrypoint,omitempty"`
	...
	UpstreamModelUpdateIgnoredModels      []string              `json:"upstream_model_update_ignored_models,omitempty"`       // 手动忽略的可加入模型
