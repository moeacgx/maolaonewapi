...
- 当前最新基线：`origin/custom-main@a9af80d63b21dcdda7c08d4b418a5f7f24fdb1a4`（`v1.0.0-rc.10.1.10.288`）
- 近期合并参考：`#139` `#138` `#137` `#133` `#132` `#131` `#130` `#129` `#128` `#127` `#126` `#124` `#123` `#122` `#121` `#120`
- 本轮运行验证：`2026-08-31`
- 配套文件：
