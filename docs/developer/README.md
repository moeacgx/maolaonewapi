...
- [xAI 分组权限、操练场 400 与错误日志修复](../workflows/2026-09/07_xai_group_access_and_playground_errors.md)：修复多实例配置同步死锁、提前鉴权错误落库，并为 OpenAI 协议接入的 Grok 操练场请求启用窄范围 Chat→Responses 兼容转换。
