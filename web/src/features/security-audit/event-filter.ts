...
*/
import type { SecurityAuditEventFilter } from './types'

export function cleanSecurityAuditEventFilter(
  ...
  ) as SecurityAuditEventFilter
}

export function hasSecurityAuditEventFilter(filter: SecurityAuditEventFilter) {
  return Object.keys(cleanSecurityAuditEventFilter(filter)).length > 0
}
