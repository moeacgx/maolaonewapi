...
function getEndpointTokenStatus(
  endpoint: SecurityAuditEndpointDraft,
  t: TFunction
) {
  if (endpoint.has_token && endpoint.token_action !== 'clear') {
    return t('Configured')
  }
  if (endpoint.token_action === 'replace' && endpoint.token) {
    return t('Pending replacement')
  }
            ...
            <Card key={endpoint.id}>
              ...
              <CardContent className='grid gap-3 text-sm sm:grid-cols-2'>
                ...
                <div className='flex flex-col gap-1'>
                  ...
                  <span>{getEndpointTokenStatus(endpoint, t)}</span>
                </div>
                <div className='flex flex-col gap-1'>
                  <span className='text-muted-foreground text-xs'>
                    {t('Timeout')}
