...
export const STATIC_I18N_KEYS = [
  ...
  'Text function call to Images API',
  ...
  'Responses image function bridge injects a private function and buffers streaming until the source model decides whether to call it.',
