 ...
 * link (`target="_blank"`, mail clients, another site) carries a live opener,
 * and that opener survives the cross-origin round trip to the identity
 * provider. Such a login callback can otherwise be misread as a bind.
 *
 ...
 * else is a login, which is also the safe default.
 */
