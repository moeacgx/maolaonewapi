...
const NotificationButton = ({ unreadCount, onNoticeOpen, t, bare = false }) => {
  const buttonProps = {
    icon: <Bell size={18} />,
    'aria-label': t('系统公告'),
    title: t('系统公告'),
    ...
    type: 'tertiary',
    className: bare
      ? '!p-1.5 !text-current focus:!bg-semi-color-fill-1 dark:focus:!bg-gray-700 !rounded-lg hover:!bg-semi-color-fill-1 dark:hover:!bg-semi-color-fill-2'
