...
func updateVideoSingleTask(ctx context.Context, adaptor channel.TaskAdaptor, channel *model.Channel, taskId string, taskM map[string]*model.Task) error {
					...
					if hasRatioSetting && modelRatio > 0 {
						...
						if group != "" {
							...
							if quotaDelta > 0 {
								...
								if err := model.DecreaseUserQuotaCommitted(task.UserId, quotaDelta); err != nil {
								...
								if err := model.IncreaseUserQuotaCommitted(task.UserId, refundQuota); err != nil {
	...
	if shouldRefund {
		...
		if err := model.IncreaseUserQuotaCommitted(task.UserId, quota); err != nil {
